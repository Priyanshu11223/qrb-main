                        ...
                        <div class="card p-o">
                            <div class="card-header">
                                ...
                                <div class="col-lg-6  custom_right">
                                    <a href="#" class="btn float-right custom-left delete-action btn-danger text-light btn-lg" data-form-id="delete-form-{{ $currantLang }}">
                                    ...
                                    <a href="{{ route('create.language', [$currantLang]) }}"
                                        class="btn float-right btn-primary text-light btn-lg" id="create">{{__('Create')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
