            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.is_success) {
                        ...
                        $('.card-body').html(
                            '<div class="text-center gallery" id="success_loader"><img src="{{ asset('assets/images/success.gif') }}" class="" /><br><br><h2 class="w-100 "> Form Saved Successfully...</h2></div>');
            ...
            $.ajax({
                ...
                success: function(response) {
                   ...
                   if (response.is_success && partialSave) {
                        ...
                        // $('.card-body').html(
                        //     '<div class="text-center gallery" id="success_loader"><img src="{{ asset('assets/images/success.gif') }}" class="" /><br><br><h2 class="w-100 ">Your form is saved partially.</h2></div>');
                        
                        if($save_as_draft) {
                            $('.card-body').html(
                                '<div class="text-center gallery" id="success_loader">' +
                                '<img src="{{ asset('assets/images/success.gif') }}" class="" />' + 
