...
Route::get('/audit/page1', ['as' => 'audit.page1', 'uses' => '\App\Http\Controllers\PageController@index'])->middleware(['xss']);
...
Route::get('/form-values/{id}/uedit', ['as' => 'uedit.form.values', 'uses' => '\App\Http\Controllers\FormValueController@userEdit'])->middleware(['auth', 'xss']);
